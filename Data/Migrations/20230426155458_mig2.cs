        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngredientIdIngredient = table.Column<int>(type: "int", nullable: true),
                    RecipeIdRecipe = table.Column<int>(type: "int", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeIngredient", x => x.IdRecipeIngredient);
                    table.ForeignKey(
                        name: "FK_RecipeIngredient_Ingredients_IngredientIdIngredient",
                        column: x => x.IngredientIdIngredient,
                        principalTable: "Ingredients",
                        principalColumn: "IdIngredient");
                    table.ForeignKey(
                        name: "FK_RecipeIngredient_Recipes_RecipeIdRecipe",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeIngredient_IngredientIdIngredient",
                table: "RecipeIngredient",
                column: "IngredientIdIngredient");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeIngredient_RecipeIdRecipe",
                table: "RecipeIngredient",
